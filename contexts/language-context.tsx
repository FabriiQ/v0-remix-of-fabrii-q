...
const translations = {
  ...
  es: {
    ...
    // Footer
    "footer.powered_by": "Desarrollado por FabriiQ",
  ...
  fr: {
    ...
    // Footer
    "footer.powered_by": "Propulsé par FabriiQ",
  ...
  de: {
    ...
    // Footer
    "footer.powered_by": "Betrieben von FabriiQ",
  ...
  ja: {
    ...
    // Footer
    "footer.powered_by": "FabriiQによって提供",
