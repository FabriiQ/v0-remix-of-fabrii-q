    ...
    <div className="min-h-screen bg-black text-white">
      ...
      <section className="py-20 px-4 sm:px-6 bg-gradient-to-b from-gray-900 to-black">
        <div className="max-w-4xl mx-auto">
          ...
          >
            <div className="text-center mb-8">
              <h3 className="text-2xl font-bold text-white mb-4">{t('partnership_extended.intelligence.title')}</h3>
              <p className="text-gray-400">{t('partnership_extended.intelligence.description')}</p>
            </div>
